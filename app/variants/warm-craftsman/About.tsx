...
/**
 * About page (warm craftsman): title + lead intro, a supporting hero photo, then the
 * merged company story (about / vision / quality / alpinist credibility) as one
 * coherent narrative. Mirrors the service detail layout.
 */
