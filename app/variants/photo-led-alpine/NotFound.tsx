...
export function NotFound() {
  return (
    <main className="container-page flex min-h-[60vh] flex-col items-center justify-center py-24 text-center">
      <div className="mb-6 text-[10px] font-bold tracking-[0.25em] uppercase text-orange">
        Napaka 404
      </div>
      ...
      <Link
        to="/"
        className="bg-orange text-paper hover:bg-orange-dark mt-10 inline-flex items-center gap-2 px-7 py-4 text-sm font-bold transition-colors"
      >
